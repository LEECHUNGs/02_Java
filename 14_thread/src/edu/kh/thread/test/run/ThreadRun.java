...
public class ThreadRun {
	...
	// 쓰레드를 사용해 메인 작업과 병렬로 처리할 수 있음
	
	// 병렬 처리는 하나으 작업을 여러 부분으로 나누어서 동시에 처리하는 것
	...
	public static void main(String[] args) {
		...
		// start나, stop 같은 Thread 메서드를 사용할 수 없다.
		// -> Thread 클래스에 Runnable 인터페이스를 상속받아 구현한
		// ThreadWhithRunnable 객체를 전달하여 사용해야 함!
