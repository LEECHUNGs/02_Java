...
public class PolyService {
	...
	public void ex1() {
		...
		car2.setEngine("전기모터");
		car2.setFuel("전기");
		// car2.setBatterayCapacity(100000);
		// The method setBatterayCapacity(int) is undefined for the type Car
		...
		// 객체 배열 : 같은 객체 참조 자료형의 변수를 하나의 묶으므로 다루는 것
	...
	// 전달답은 Car 또는 자식객체(Tesla, Spark)의 엔진, 연료, 바퀴갯수를 출력하는 메서드
	...
	public void ex2() {
		...
		// -> 참조하는 객체가 특정 자료형이거난 부모쪽 상속관계인지 확인
	...
	public void ex5() {
		...
		// 참조변수 c2가 Car 타입 이므로
		// toString()도 Car 의  toString() 호출 - 정적 바인딩
		
		// 하지만 실행하면 자식(Spark)의 toString()이 호출되는 것을 확인
