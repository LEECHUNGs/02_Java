...
public class InheritanceService {
	...
	public void ex1() {
		...
		p.setName("홍길동");
		p.setAge(25);
		p.setNationlity("대한민국");
		
		System.out.println(p.getName());
		System.out.println(p.getAge());
		System.out.println(p.getNationlity());
		...
		System.out.println(std.getNationlity());
		...
		emp.setName("조미현");
		emp.setAge(20);
		emp.setNationlity("대한민국");
		
		System.out.println(emp.getCompany());

		System.out.println(emp.getName());
		System.out.println(emp.getAge());
		System.out.println(emp.getNationlity());
	...
	public void ex4() {
		...
		Employee emp = new Employee("삼성", "이백점", 18, "미국");
