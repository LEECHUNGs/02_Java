...
public class Employee extends Person{
	...
	// 매개변수생성자
	public Employee(String company, String name, int age, String nationality) {
	...
	// @Override 어도테이션 : 해당 메서드가 오버라이딩 되었음을
	// 			컴파일러에게 알리는 역할 -> 컴파일러에게 문법체크 등 하도록 알림
	
	// 어노테이션(Annotation) : 컴파일러에게 알려주기 위한 코드 (컴파일러 인식)
