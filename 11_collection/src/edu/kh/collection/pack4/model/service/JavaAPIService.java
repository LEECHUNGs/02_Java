...
public class JavaAPIService {
	 ...
	 * 
	 * 
	 * * Boxing, Unboxing을 자동으로 수행하도록 구현되어있음
	...
	public void method2() {
		...
		System.out.println("byte의 최대값 : " + Byte.MAX_VALUE + "비트");
		System.out.println("byte의 최소값 : " + Byte.MIN_VALUE + "비트");
		...
		System.out.println("[기본 자료형 -> Striing 변환]");
		
		// String 이어쓰기를 이용한 방법
		// -> 코드는 짧으나 효율이 좋지 않음(속도 down, 메모리 소모 up
		long test1 = 123456789L;
	...
	public void method6() {
		...
		// 문자열을 구분자를 기준으로 나누어 String[]로 반환
		...
		// equalsIgnoreCase() : 문자열을 비교 시 대소문자를 무시하고 비교하는 메서드
		String str1 = "hello";
		String str2 = "HELLO";
