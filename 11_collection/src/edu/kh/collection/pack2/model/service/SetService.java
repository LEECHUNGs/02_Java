...
public class SetService {
	...
	public void method3() {
		...
		// A.equals(B) : A와 B가 가지고있는 필드값이 같아면 true
		System.out.println(p1.equals(p2));
		System.out.println(p1.equals(p3));
		
		// *********************************************
		// Hash 라는 단어가 포함된 컬렉션 사용 시
		// hashCode(), equals() 오버라이딩 필수적 진행!!!
		// *********************************************
