package edu.kh.opp.methode.model.service;

import java.util.Scanner;


import edu.kh.opp.methode.model.vo.Member;
...
public class MemberService {
	...
	public void displayMenu() {
		...
		do {
			...
			case 1 : System.out.println(/* 회원 가입 기능 호출 */signUp()); break;
			...
			default : System.out.println("잘못 입력하셨습니다. 메뉴에 있는 번호만 입력해 주세요.");
			}
	...
	public String signUp() {
		...
		if(memberPw.equals(memberPw2)) { // 일치하는 경우
			...
			// 입력받은 정보를 이용해 Member 객체를 생성 후
			// 생성된 객체 주소를 필드에 잇는 memberInfo에 대입
	...
	public String logIn() {
		...
		// 저장된 아이디, 비밀번호가
		// 입력받은 "아이디, 비밀번호와 일치하면 로그인 성공"
		// 틀리면 "아이디 또는 비밀번호가 일치하지 않습니다" 리턴
	...
	public int updateMember() {
		...
		System.out.print("수정하려면 비밀번호를 입력하세요 : ");
		String inputPw = sc.next();
		
		if((loginMember.getMemberPw()).equals(inputPw)) {
			// -> 비밀번호가 같을 경우, 로그인할 회원의 이름, 나이 정보를 입력받은 값으로 변경 후 1 반환
